 ...
 * actual OpenAI API. The expectation is:
 *  - strict is TRUE only when all object nodes in the schema tree have additionalProperties: false
 *    and required exactly equals the set of properties (no optional fields), recursively.
 *  - otherwise strict should not be TRUE (it may be false or null depending on implementation).
 */
