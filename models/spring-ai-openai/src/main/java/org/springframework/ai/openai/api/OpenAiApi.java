...
public class OpenAiApi {
	...
	public record ChatCompletionRequest(// @formatter:off
		...
		public ChatCompletionRequest streamOptions(StreamOptions streamOptions) {
			...
			this.tools, this.toolChoice, this.parallelToolCalls, this.user, this.reasoningEffort, this.webSearchOptions, this.verbosity, this.promptCacheKey, this.thinking);
		}
		 ...
		 * @param clearThinking - should be false for the case Preserved thinking. Otherwise, it is Interleaved thinking
		 *
		 * @see <a href="https://docs.z.ai/guides/capabilities/thinking-mode">Z.ai GLM-4.7 Thinking Mode</a>
		 */
		@JsonInclude(Include.NON_NULL)
		public record Thinking(
				@JsonProperty("type") String type,
				@JsonProperty("clear_thinking") Boolean clearThinking) {
		}
