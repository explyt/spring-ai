...
public class GoogleGeminiRetryTests {
	...
	public void googleGeminiChatTransientError() {
		...
		ChatCompletion expectedChatCompletion = new ChatCompletion(List.of(new Candidate(choice)),
				new GoogleGeminiApi.Usage(10, 10, 10, 10));
	...
	public void googleGeminiChatStreamTransientError() {
		...
		var choice = new ChatCompletionMessage(ChatCompletionMessage.Role.ASSISTANT, "Response");
		var completion = new ChatCompletion(List.of(new Candidate(choice)), new GoogleGeminiApi.Usage(10, 10, 10, 10));
