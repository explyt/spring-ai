...
public class GoogleGeminiUsage implements Usage {
	...
	public Integer getCompletionTokens() {
		var candidatesTokenCount = this.usage.candidatesTokenCount();
		var toolUsePromptTokenCount = this.usage.toolUsePromptTokenCount();
		var thoughtsTokenCount = this.usage.thoughtsTokenCount();
		...
		tokenCount += thoughtsTokenCount != null ? thoughtsTokenCount : 0;
		return tokenCount;
	}
