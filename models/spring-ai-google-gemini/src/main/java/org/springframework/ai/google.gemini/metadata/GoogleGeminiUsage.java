...
public class GoogleGeminiUsage implements Usage {
	...
	public Long getPromptTokens() {
		return getUsage().promptTokenCount().longValue();
	}

	@Override
	public Long getGenerationTokens() {
		return getUsage().candidatesTokenCount().longValue();
	}

	public Long getCacheHitTokens() {
		return getUsage().cachedContentTokenCount().longValue();
	}

	public Long getCacheMissTokens() {
		return getGenerationTokens() - getCacheHitTokens();
	}

	@Override
	public Long getTotalTokens() {
		return getUsage().totalTokenCount().longValue();
	}
