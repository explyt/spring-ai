...
package org.springframework.ai.google.gemini.api.schema;
 ...
 * @since 1.0.0
 */
public class GeminiToolCallingManager implements ToolCallingManager {
	 ...
	 */
	public GeminiToolCallingManager(ToolCallingManager delegateToolCallingManager) {
	...
	public List<ToolDefinition> resolveToolDefinitions(ToolCallingChatOptions chatOptions) {
		return this.delegateToolCallingManager.resolveToolDefinitions(chatOptions);
