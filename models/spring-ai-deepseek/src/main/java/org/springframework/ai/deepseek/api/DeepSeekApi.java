...
public class DeepSeekApi {
	...
	public DeepSeekApi(String baseUrl, String deepseekToken) {
		this(baseUrl, deepseekToken, RestClient.builder());
	}
	 ...
	 */
	public DeepSeekApi(String baseUrl, String deepseekToken, RestClient.Builder restClientBuilder) {
		this(baseUrl, deepseekToken, restClientBuilder, RetryUtils.DEFAULT_RESPONSE_ERROR_HANDLER);
	}
	 ...
	 */
	public DeepSeekApi(String baseUrl, String deepseekToken, RestClient.Builder restClientBuilder, ResponseErrorHandler responseErrorHandler) {
	...
	public enum ChatModel implements ModelDescription {
		/**
		 * The backend model of deepseek-chat has been updated to DeepSeek-V2,
		 * you can access DeepSeek-V2 without modification to the model name.
		 * The open-source DeepSeek-V2 model supports 128K context window,
		 * and DeepSeek-V2 on API/Web supports 32K context window.
		 * Context window: 32k tokens
		 */
		DEEPSEEK_CHAT("deepseek-chat"),

		/**
		 * DeepSeek Coder is composed of a series of code language models, good at coding tasks.
